    ...
    useEffect(() => {
        const fetchDeviceData = async () => {
            ...
            try {
                ...
                const response = await axios.get(`${process.env.REACT_APP_API_URL}/librarian/devices/${category}/${model}/${copyId}`, {
                    headers: {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (isEditMode) {
                ...
                await axios.put(`${process.env.REACT_APP_API_URL}/librarian/devices/${category}/${model}/${copyId}`, {
                ...
                // Add new device
                await axios.post(`${process.env.REACT_APP_API_URL}/librarian/devices`, formData, {
                    headers: {
                        "Authorization": `Bearer ${token}`,
                        "Content-Type": "application/json"
                    }
